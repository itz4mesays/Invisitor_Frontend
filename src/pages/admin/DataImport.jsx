      ...
      <div className="di-content-grid">
        ...
        <div className="di-card">
          <div className="di-tabs">
            ...
            <button 
              className={`di-tab ${activeTab === 'users' ? 'active' : ''}`}
              onClick={() => { setActiveTab('users'); clearFile(); }}
            >
              Users Data
            </button>
          </div>
          ...
          <div className="di-instructions">
            <h3>Upload {activeTab === 'residents' ? 'Residents' : activeTab === 'security' ? 'Security' : 'Users'}</h3>
            <p>
            ...
            <button className="di-template-btn" onClick={handleDownloadTemplate}>
              <Download size={14} /> Download {activeTab === 'residents' ? 'Resident' : activeTab === 'security' ? 'Security' : 'Users'} Template
            </button>
          </div>
