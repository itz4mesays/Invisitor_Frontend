      ...
      <div className="list-subheader">
        ...
        <div className="list-actions">
          <button className="text-btn">
            <div style={{ display: 'flex', alignItems: 'center', gap: '4px', transform: 'rotate(90deg)' }}>
        ...
        {isDetailModalOpen && (
          ...
          >
            <div className="add-appointment-modal-content">
              ...
              <div className="visitor-confirm-card" style={{ background: '#f8fafc', padding: '1.5rem', borderRadius: '20px', width: '100%' }}>
                <div className="avatar-wrapper larger">
                  <img src={selectedAppointment?.avatar} alt="" className="v-avatar" />
                  <div className="verify-badge">
                    <Check size={8} strokeWidth={4} color="white" />
              ...
              <div className="form-grid-2-col" style={{ marginTop: '1rem' }}>
                <div className="detail-row">
                  ...
                  <span className="detail-value" style={{ fontSize: '1rem', fontWeight: '700', color: '#0d2331' }}>{selectedAppointment?.date}</span>
                </div>
                <div className="detail-row">
                  ...
                  <span className="detail-value" style={{ fontSize: '1rem', fontWeight: '700', color: '#0d2331' }}>{selectedAppointment?.time}</span>
                </div>
                <div className="detail-row">
                  ...
                  <span className="detail-value" style={{ fontSize: '1rem', fontWeight: '700', color: '#0d2331' }}>{selectedAppointment?.duration}</span>
                </div>
                <div className="detail-row">
                  ...
                  <span className="detail-value" style={{ fontSize: '1rem', fontWeight: '700', color: '#0d2331' }}>{selectedAppointment?.host}</span>
                </div>
              </div>
